...
class Ns_Followers:
    def __init__(self):
        ...
        self.__username='beyim33793' #Enter UserName Here
        self._session='66597327661%3AHtGp65yisCrFp7%3A11%3AAYc4d6yFIrh7G6mukcbanNGs7Ux-DiHxYpYG-9p0Qw' #Enter SessionID Here
